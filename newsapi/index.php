    ...
    <div class="container" style="margin-top:30px">
      <div class="row">
        <div class="col-sm-4">
            ...
            <p class="text-muted small p-3">Hello my name is Nifemi Idowu ,i'm a web developer in the making..
          ...
          ?>
            <div class="card" style="width:400px">
              ...
              <div class="card-body">
                ...
                <a class="btn btn-sm btn-warning stretched-link" role="button" href="<?php echo $value['readMoreUrl'] ?>">read more</a>
              </div>
            </div>
